...
try:
    ...
    if tk.TkVersion < 8.0:
        raise RuntimeError('You are running Tk version: ' + str(
            tk.TkVersion) + 'You must be using Tk version 8.0 or greater to use PyMsgBox.')
...
import \
    pymsgbox.native as native  # This needs to be after the above functions so that the unimplmeneted native functions can default back to the above functions.
