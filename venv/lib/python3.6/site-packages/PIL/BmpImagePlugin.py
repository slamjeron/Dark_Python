...
class BmpImageFile(ImageFile.ImageFile):
    ...
    def _bitmap(self, header=0, offset=0):
        ...
        header_data = ImageFile._safe_read(self.fp, file_info[
            'header_size'] - 4)  # read the rest of the bmp header, without its size
        # --------------------------------------------------- IBM OS/2 Bitmap v1
        ...
        # ---------------------------------------------- Windows Bitmap v2 to v5
            ...
            if file_info['header_size'] >= 40:  # v3 and OS/2
                ...
                file_info['height'] = i32(header_data[4:8]) if not file_info['y_flip'] else 2 ** 32 - i32(
                    header_data[4:8])
                ...
                if file_info['compression'] == self.BITFIELDS:
                    ...
                    file_info['rgba_mask'] = (
                        file_info['r_mask'], file_info['g_mask'], file_info['b_mask'], file_info['a_mask'])
        else:
