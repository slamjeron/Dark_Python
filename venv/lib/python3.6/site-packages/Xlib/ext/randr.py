...
class SetCrtcTransform(rq.Request):
    _request = rq.Struct(
        ...
        rq.List('filter_params', rq.Card32Obj),
...
class GetCrtcTransform(rq.ReplyRequest):
    ...
    _reply = rq.Struct(
        ...
        rq.List('pending_filter_params', rq.Card32Obj),
        # FIXME: The protocol says FIXED? http://cgit.freedesktop.org/xorg/proto/randrproto/tree/randrproto.txt#n2161
        rq.String8('current_filter_name'),
        rq.List('current_filter_params', rq.Card32Obj),
        # FIXME: The protocol says FIXED? http://cgit.freedesktop.org/xorg/proto/randrproto/tree/randrproto.txt#n2161
    )
...
def set_panning(self, crtc, left, top, width, height, track_left, track_top, track_width, track_height, border_left,
                border_top, border_width, border_height, timestamp=X.CurrentTime):
    return SetPanning(
        display=self.display,
        opcode=self.display.get_extension_major(extname),
        crtc=crtc,
